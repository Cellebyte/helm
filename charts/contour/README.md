...
```console
$ helm repo add cellebyte https://cellebyte.github.io/helm
$ helm install my-release cellebyte/contour
```
...
| `configInline`                                     | Specify the config for metallb as a new configMap inline.                                              | `{Quickstart Config}` (does not create configMap)       |
